...
function main() {
  ...
  // Argentina tiene que estar escrita explícitamente en el título o la
  // descripción, no alcanza con que vos "sepas" que está relacionado.
  if (!mentionsArgentina(evento)) {
    throw new Error(
      'La descripción y el título no mencionan la palabra "Argentina"/"argentino" en ningún lado. ' +
      'Agregá al texto de la descripción por qué este evento tiene relación con Argentina ' +
